  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Busca de Leitores</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					<tbody>
						<?php 
						  if(isset($_POST['texto'])){
							 ...
							 $sql = "select * from tbleitor where nome like '%".$_POST['texto']."%' ";
                       ...
                       <td>'.$linha['email'].'</td>
										   <td width="20%">
										   <a href="frmalt.php?id='.$linha['id_leitor'].'" title="Alterar" class="btn btn-sm btn-primary">
											 <i class="fa fa-edit"></i>&nbsp;Alterar
										   </a>
										   <a href="../controle/leitor/apagar.php?id='.$linha['id_leitor'].'" onclick="validarDelete()" title="Excluir" class="btn btn-sm btn-danger" >
