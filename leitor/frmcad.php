        ...
        <div class="row">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input name="fone" type="tel" class="form-control" placeholder="Informe o Número de Telefone para Contato" required>
                  </div>
                 </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input name="numero" type="text" class="form-control" placeholder="Informe o Número" required>
                  </div>
                 </div>
                </div>
