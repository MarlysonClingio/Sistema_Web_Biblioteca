  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Devolução de Empréstimo</h1>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-body">
                  <form name="f1" method="POST" action="../controle/empdev/atualizar.php" onsubmit="return validar()">
					...
					<div class="alert alert-light">
					   <b>Título: </b><?php echo $_GET['titulo']?><br>
					   <b>Leitor: </b><?php echo $_GET['leitor']?>				   
					</div>
					<div class="form-group">             
						<div class="col-md-12">
						   ...
						   <div class="input-group">
							...
							<input value="<?php date_default_timezone_set('America/Fortaleza'); echo date('Y-m-d');?>" name="data_dev" type="date" class="form-control" required>						
						   </div>
						</div>  
					</div>
					<hr>
					<div class="form-group">
					    <button type="submit" class="btn btn-success"><i class="fa fa-save"></i>&nbsp;Devolver</button>
