						  ...
						  if(isset($_POST['texto'])){
							 ...
							 foreach($busca as $linha){
								 echo '<tr>						   
										   ...
										   <td>'.$linha['autor'].'</td>
										   <td width="20%">
										   <a href="frmalt.php?id='.$linha['id_acervo'].'" title="Alterar" class="btn btn-sm btn-primary">
											 <i class="fa fa-edit"></i>&nbsp;Alterar
										   </a>
										   <a href="../controle/acervo/apagar.php?id='.$linha['id_acervo'].'" onclick="validarDelete()" title="Excluir" class="btn btn-sm btn-danger" >
