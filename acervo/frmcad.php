          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-body">
				...
				?> 
                  <form name="f1" method="POST" action="../controle/acervo/salvar.php" onsubmit="return validar()">
					...
					<div class="form-group">             
						<div class="col-md-12">
						   ...
						   <div class="input-group">
							...
							<input name="titulo" type="text" class="form-control" placeholder="Informe o Título" required>						
						   </div>
						</div>  
					</div>
					<div class="form-group">             
					...
					<div class="form-group">             
						<div class="col-md-12">
						   ...
						   <div class="input-group">
							...
							<input name="npaginas" type="text" class="form-control" placeholder="Informe o Número de Páginas" required>						
						   </div>
						</div>  
					</div>
					<div class="form-group">             
